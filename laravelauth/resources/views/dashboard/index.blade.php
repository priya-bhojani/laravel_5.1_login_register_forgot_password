		...
		<div class="page-content">
			...
			<div class="theme-panel hidden-xs hidden-sm">
				...
				<div class="theme-options">
					<div class="theme-option theme-option-header clearfix">
						<span>
						Dashboard View </span>
					</div>
			...
			<div class="page-bar">
				...
				<div class="page-toolbar">
					<div id="dashboard-report-range" class="pull-right tooltips btn btn-fit-height btn-daterange" data-container="body" data-placement="bottom" data-original-title="Change dashboard date range">
			...
			<div class="row stats-overview-cont">
				<div class="col-md-2 col-sm-4">
					<div class="stats-overview stat-block">
						...
						<div class="progress">
							<span style="width: 40%;" class="progress-bar progress-bar-success" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100">
							<span class="sr-only">
							30% Complete </span>
							</span>
						</div>
				...
				<div class="col-md-2 col-sm-4">
					<div class="stats-overview stat-block">
						...
						<div class="progress">
							<span style="width: 20%;" class="progress-bar progress-bar-success" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
							<span class="sr-only">
							30% Complete </span>
							</span>
						</div>
				...
				<div class="col-md-2 col-sm-4">
					<div class="stats-overview stat-block">
						...
						<div class="details">
							...
							<div class="progress">
								<span style="width: 2%;" class="progress-bar progress-bar-danger" aria-valuenow="2" aria-valuemin="0" aria-valuemax="100">
								<span class="sr-only">
								1% Complete </span>
								</span>
							</div>
			...
			<div class="row ui-sortable" id="sortable_portlets">
				<div class="col-md-6 col-sm-12 column sortable">
					...
					<div class="portlet portlet-sortable">
						<div class="portlet-title">
							<div class="caption">
								<i class="icon-target"></i>KPIs (Activity v Target)
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							<div id="kpi_statistics_loading" class="display-none">
								<img src="img/loading.gif" alt="loading"/>
							</div>
							<div id="kpi_statistics_content">
								<div id="kpi_statistics" class="chart" style="height:300px; width:100%;">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="portlet portlet-sortable">
						<div class="portlet-title">
							<div class="caption">
								<i class="icon-bar-chart"></i>Placements Graph
							</div>
							<div class="actions">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="icon-lock"></i>Latest Placements
							</div>
							<div class="actions">
								<div class="btn-group">
									...
									<div class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">
										<label><input type="checkbox"/> Panthers</label>
										<label><input type="checkbox" checked=""/> Ninjas</label>
				...
				<div class="col-md-6 col-sm-12 column sortable">
											...
											<li>
												<div class="col1">
													<div class="cont">
														...
														<div class="cont-col2">
															<div class="desc">
																 You have 4 pending tasks. &nbsp;<span class="label label-sm label-danger">Take action</span>
															</div>
														</div>
													</div>
												</div>
							...
							<div class="actions">
								<div class="btn-group">
									...
									<ul class="dropdown-menu pull-right">
										<li>
											<a href="#"><i class="i"></i> All Tasks</a>
										</li>
										<li class="divider">
										</li>
										<li>
										...
										<li>
											<a href="#">Personal Tasks</a>
										</li>
										
										<li class="divider">
										</li>
										<li>
											<a href="#">Due Today <span class="badge badge-important">
											4 </span>
											</a>
										</li>
										<li>
											<a href="#">Overdue <span class="badge badge-danger">
											9 </span>
											</a>
										</li>
									</ul>
									...
									<ul class="task-list">
										<li>
											...
											<div class="task-title">
												...
												Pellentesque quis venenatis felis. Curabitur hendrerit enim nec  </span>
					...
					<div class="portlet portlet-sortable">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-comments-o"></i>Rubicon Chat
							</div>
							<div class="tools">
								<a href="" class="collapse"></a>
								<a href="" class="reload"></a>
								...
								<ul class="chats">
									<li class="in">
										...
										<div class="message">
											...
											<a href="#" class="name">Sarah Lance</a>
											<span class="datetime">
											at June 16 2015 11:09 </span>
											<span class="body">
									...
									<li class="out">
										...
										<div class="message">
											...
											<a href="#" class="name">Barry Allen</a>
											<span class="datetime">
											at June 16 2015 11:09 </span>
											<span class="body">
											Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. </span>
									...
									<li class="out">
										...
										<div class="message">
											...
											<a href="#" class="name">Oliver Queen</a>
											<span class="datetime">
											at June 16 2015 11:09 </span>
											<span class="body">
											Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. </span>
